import { SET_NUMBER_OF_BUSINESSES, ADD_FIREBASE_ID, SET_USER_ID, ADD_BUSINESS_IDS, SIGN_IN, SIGN_OUT, ADD_CUSTOMER_EMAIL, ADD_CUSTOMER_SESSION_ID, CUSTOMER_PURCHASE_FAILED, CUSTOMER_PURCHASE_SUCCESSFUL, ADD_CUSTOMER_NAME } from "../actiontypes"

export const SetNumberOfBusinesses = (num) => ({
    type: SET_NUMBER_OF_BUSINESSES,
    payload: num
})
